Hostsharing-Ansible-RustDesk
============================

This Ansible playbook will install the latest RustDesk release on a server from www.hostsharing.net.
...
We clone this git-repo to our machine:
    ...
    $ git clone https://github.com/tpokorra/Hostsharing-Ansible-RustDesk.git

Then we change the working directory:

    $ cd Hostsharing-Ansible-RustDesk
